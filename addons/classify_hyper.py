...
class HyperbolicRNNModel(Classifier):
    def __init__(self):
        super().__init__()
    ...
    def make_input(self, batch_dict, do_dropout=False):
        ...
        feed_dict = {self.x: x, self.lengths: lengths, self.pkeep: pkeep}
    ...
    def create(labels, embeddings, **kwargs):
        ...
        model.y = kwargs.get('y', tf.placeholder(tf.int64, [None], name="y"))
        ...
        model.best = tf.argmax(model.probs, 1)
